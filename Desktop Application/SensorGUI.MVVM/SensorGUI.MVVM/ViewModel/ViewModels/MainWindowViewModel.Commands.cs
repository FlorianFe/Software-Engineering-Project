...
namespace SensorGUI.MVVM {
    public partial class MainWindowViewModel {
        ...
        private void InitCommands() {
            ...
            this.HelpCommand = new RelayCommand(HelpExecute, HelpCanExecute);
        ...
        private void ChangeConfigExecute(object obj) {
            ...
            if(success == true) {
                ...
                executer.execute(new ConfigFromXMLCommand(executer, Path, this.measurementSeriesCollection));
        ...
        public void MeasurementNewExecute(object obj) {
        ...
        public void MeasurementCancelExecute(object obj) {
            ShowCancelDialog(ViewModel => DialogService.ShowDialog<SensorGUI.MVVM.Views.CancelWindow>(this, ViewModel));
        }
        public void ShowCancelDialog(Func<CancelWindowViewModel, bool?> showDialog) {
        ...
        public void MeasurementSaveExecute(object obj) {
            ShowSaveDialog(ViewModel => DialogService.ShowDialog<SensorGUI.MVVM.Views.SaveWindow>(this, ViewModel));
        }
        public void ShowSaveDialog(Func<SaveWindowViewModel, bool?> showDialog) {
        ...
        public void ChangeMeasurementSeriesExecute(object obj) {
        ...
        public void StopExecute(object obj) {
            this.Loading = true;
        ...
        private void ChangeTriggererExecute(object obj) {
            /*for(int i = 0; i < this.Users.Count; i++) {
                if ((int)obj == i) {
                    this.Users.ElementAt(i).IsTriggerer = true;
                } else {
                    this.Users.ElementAt(i).IsTriggerer = false;
                }
            }
            /*var id = (Guid)e;
        ...
        private bool HelpCanExecute(object obj)
        {
            return false;
        }
        ...
        private bool ChangeTriggererCanExecute(object obj) {
            return (!this.Users.Any(u => u.IsTriggerer)) && (State == ApplicationState.Idle || State == ApplicationState.Ready);
        }

        // Mobile Commands
        public void CancelFromApp()
        {
            this.ConfigEnabled = true;
            this.Timer = "00:00";
            this.Loading = false;
        ...
        public void SaveFromApp(string MeasurementName)
        {
            this.ConfigEnabled = true;
            this.SeriesEnabled = true;
            this.Timer = "00:00";
            this.executer.execute(new ChangeNameOfLastMeasurementSeriesCommand(this.measurementSeriesCollection, MeasurementName));
            State = ApplicationState.Ready;
        }
        #endregion
    }
