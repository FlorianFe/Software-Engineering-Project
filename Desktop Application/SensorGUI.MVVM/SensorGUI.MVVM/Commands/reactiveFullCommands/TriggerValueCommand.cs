    ...
    namespace reactivecommands
    {
        public class TriggerValueCommand : ReactiveFullCommand
        {
            ...
            public override void executeOnPort1(System.IO.Ports.SerialPort port1)
            {
                ...
                Console.WriteLine("Execute Trigger Command");
            }
            ...
            public override void react(char[] answerData1, char[] answerData2, ObserverCollection observerCollection)
            {
                ...
                RepeatingAccuracyMeasurement measurement = new RepeatingAccuracyMeasurement(values[0], values[1], values[2]);
                ...
                if (series is RepeatingAccuracyMeasurementSeries)
                {
                    ...
                    repeatingAccuracyMeasurementSeries.addMeasurement(measurement);
                }
                else
                {
                ...
                if(counter != 3) 
                {
                    ...
                    observerCollection.onRepeatingAccuracyMeasurementAdded(measurement);
