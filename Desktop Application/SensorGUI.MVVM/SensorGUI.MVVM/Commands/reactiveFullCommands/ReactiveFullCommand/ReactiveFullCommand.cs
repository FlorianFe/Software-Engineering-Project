...
namespace commands
{
    namespace reactivecommands
    {
        public abstract class ReactiveFullCommand
        {
            ...
            abstract public void react(char[] answerData1, char[] answerData2, ObserverCollection observerCollection);
            ...
            public void reactOnPort1(char[] answerData, ObserverCollection observerCollection)
            {
                this.bufferedAnswerData1 = answerData;
                if (this.bufferedAnswerData2 != null)
                {
                    this.react(answerData, bufferedAnswerData2, observerCollection);
                    this.bufferedAnswerData1 = null;
                    this.bufferedAnswerData2 = null;
                }
            }

            public void reactOnPort2(char[] answerData, ObserverCollection observerCollection)
            {
                this.bufferedAnswerData2 = answerData;
                if (this.bufferedAnswerData1 != null)
                {
                    this.react(bufferedAnswerData1, answerData, observerCollection);
                    this.bufferedAnswerData1 = null;
                    this.bufferedAnswerData2 = null;
                }
            }
