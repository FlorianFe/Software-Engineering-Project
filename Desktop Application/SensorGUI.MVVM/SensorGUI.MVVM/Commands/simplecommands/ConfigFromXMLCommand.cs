...
namespace commands {
    namespace simplecommands {
        public class ConfigFromXMLCommand : SimpleCommand {
            ...
            public ConfigFromXMLCommand(CommandExecuter ce, string path, MeasurementSeriesCollection measurementSeriesCollection) {
                this.path = path;
            ...
            {
                String[] substrings = this.path.Split('\\');
                ...
                {
                    this.measurementSeriesCollection.setModeToRepeatingAccuracy();
                    observers.onConfigurationChanged(1);
                }
                else if (configIdentifier.Equals("wz", StringComparison.InvariantCultureIgnoreCase))
                {
                    this.measurementSeriesCollection.setModeToWayTime();
                    observers.onConfigurationChanged(2);
                }
